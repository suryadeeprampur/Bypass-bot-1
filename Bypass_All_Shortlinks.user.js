...
// @include /^(https?:\/\/)(.+)?((blogtechh|host2loan|techbixby|wptohost|hosttbuzz|blog-blend|blogmystt|wp2hostt).com|clk.wiki|(oko|aii).sh|clk.kim|blog-myst.com|ins-myst.com)(\/.*)/
...
// @include /^(https?:\/\/)(.+)?((actualpost|americanstylo|beautifulfashionnailart|dadinthemaking|glowandglamcorner|listofthis|lobirtech|travelperi).com|(makego|sakazi).net|askerlikforum.com.tr)(\/.*)/
...
'use strict';
  ...
  function onHtmlLoaded() {
    ...
    BypassedByBloggerPemula(/(blogtechh|host2loan|techbixby|wptohost|hosttbuzz|blog-blend|blogmystt|wp2hostt).com|clk.wiki|(oko|aii).sh|clk.kim|blog-myst.com|ins-myst.com/, function() {ClickIfExists('button.btn.btn-primary', 2);SubmitIfExists('#nextpage', 2);
...
(function() {
    ...
    const domainRegex = /(actualpost|americanstylo|beautifulfashionnailart|dadinthemaking|glowandglamcorner|listofthis|lobirtech|travelperi).com|(makego|sakazi).net|askerlikforum.com.tr/
