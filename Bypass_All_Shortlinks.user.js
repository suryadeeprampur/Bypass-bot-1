...
'use strict';
  ...
  function onHtmlLoaded() {
    ...
    let List = ['lopteapi.com', '1link.vip'];let List1 = ['ay.live', 'aylink.co', 'gitlink.pro']; let $ = window.jQuery; let respect = ''; // Don't use My Scripts if You Change/Remove My Blogs, Except You Make Donations!!!.
