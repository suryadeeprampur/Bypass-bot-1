Debloated fork of *Bypass All Shortlinks* (originally by *bloggerpemula*), with some [additional bypasses](https://codeberg.org/Amm0ni4/bypass-all-shortlinks-debloated/src/branch/main/extra_bypasses) added.
